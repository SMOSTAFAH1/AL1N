...
public class FavoritesDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_TABLE = "CREATE TABLE " + TABLE_FAVORITES + " (" +
    ...
    private static final String SQL_DELETE_TABLE = "DROP TABLE IF EXISTS " + TABLE_FAVORITES;
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion < 3) {
            ...
            try {
                ...
                db.execSQL(
                        "INSERT INTO favorites_tmp (id, username, symbol, name, price, iconUrl, pinned, created_at) " +
                                "SELECT id, 'default_user', symbol, name, price, iconUrl, pinned, created_at FROM "
                                + TABLE_FAVORITES);
